...
## --------- 0. Setup ------------------------------------------------
setwd("/path/to/20241225_TWB_imputed_analysis")
...
## Nalls 2019 files
nalls_file      <- "/path/to/20250906_Nalls_PD_PGS_hg38.xlsx"
nalls_sheet     <- "Nalls_PD_hg_38"
nalls_gene_file <- "/path/to/near_gens_PD_GWAS.xlsx"
nalls_freq_file <- "/path/to/Nalls_PD_Loci_Frequency.xlsx"

## Foo 2020 files
foo_file        <- "/path/to/20251004_Foo_PD_GWAS_location.xlsx"
foo_freq_file   <- "/path/to/Foo_GWAS_frequency.xlsx"
